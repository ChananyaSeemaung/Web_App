...
<div class="container">
  ...
  <?php
        ...
        $data="SELECT * FROM bank WHERE b_number LIKE '$b_number'";
        $re_data=mysqli_query($conn, $data);
        $rw_data=mysqli_fetch_array($re_data);

    ?>
  <main class="form-signin w-100 m-auto">
    <form action="ad_bank_id_edit.php" method="GET">
      <img class="mb-4" src="ad_image/48.png" alt="" width="250" height="250">
        <h1 class="h3 mb-3 fw-normal"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">แก้ไขข้อมูลบัญชี<?php echo $rw_data['b_name'];?></font></font></h1>
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "b_name" id="floatinginput" value="<?php echo $rw_data['b_name'];?>">
        <label for="floating"><font "><font  required>ชื่อธนาคาร</font></font></label><br>
      </div>
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "b_number" id="floatinginput"  placeholder="เลขที่บัญชี" value="<?php echo $rw_data['b_number'];?>">
        <label for="floating"><font "><font  required>เลขที่บัญชี</font></font></label><br>
      </div>
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "b_owner" id="floatinginput" placeholder="เจ้าของบัญชี" value="<?php echo $rw_data['b_owner'];?>">
        <label for="floating"><font "><font  required>เจ้าของบัญชี</font></font></label><br>
      </div>
      <div class="mb-3">
