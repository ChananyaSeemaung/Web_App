...
<body  background="image/4e1f918ca4aacb17c036c9cbd77c5a3b.jpg" class="text-center">
<nav class="navbar navbar-light navbar-expand-md py-3" style="background-color:#FF99CC;">
    <div class="container"><img style="width: 90px;height: 90px;" src="ad_image/50.png" /><a class="navbar-brand d-flex align-items-center"><span style="color:#fff">Sweetheart jewelry shop<br />
        ...
        <button class="btn-5" onclick="document.location='index.php'">หน้าหลัก</button>
    </div>
</nav>
<div class="row">
  <div class="col"></div>
  ...
  <main class="form-signin w-100 m-auto">
    <form action="ad_datalogin.php" method="POST" >
      <img class="mb-4" src="ad_image/48.png" alt="" width="250" height="250">
      <h1 class="h3 mb-3 fw-normal"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">กรุณาเข้าสู่ระบบ</font></font></h1>

      <div class="form-floating">
        <input type="name"  class="form-control border-success" name = "user" id="floatinginput" placeholder="รหัสผ่าน"required>
        <label for="floating"><font ><font  >Username</font></font></label><br>
      </div>
      <div class="form-floating">
        <input type="Password"  class="form-control border-success" name = "password" id="floatinginput" placeholder="รหัสผ่าน"required>
        <label for="floating"><font><font  >Password</font></font></label><br>
      </div>
      <button class="btn-4">login</button>
      </main>
      </div>
      <div class="col"></div>
<footer class="text-center"style="background-color:#FF99CC;">
    <div class="container text-muted py-4 py-lg-5">
        ...
        <p class="mb-0">Sweetheart jewelry shop<br/>© 2023 Brand</p>
    </div>
</footer>
