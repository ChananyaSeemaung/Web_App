                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4 mt-4">
                            <div class="card-header">
                                ...
                                แสดงการข้อมูลการสั่งซื้อสินค้า (ชำระเงินแล้ว)
                                <div><br>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                    $sql = "SELECT * FROM order_tbl WHERE order_status='2' ORDER BY reg_date DESC";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row['reg_date'] ?></td>
                                            <td><a href="ad_ems.php?id_or=<?= $row['id_or'] ?>"><button type="button" class="btn btn-warning">แจ้งเลขพัสดุ</button></a></td>
                                            <td><a href="order_report.detail.php?id_or=<?= $row['id_or'] ?>"><button type="button"class="btn btn-success">รายละเอียด</button></a></td>
                                        </tr>
                                        <?php
                                    }
                                    mysqli_close($conn);
