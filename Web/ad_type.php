                ...
                <div class="table-responsive-xxl">
                    ...
                    <div class="card shadow">
                      <div class="card-header py-3" style="color: rgb(255,8,122);">
                          <p  style="color:#ff007b;">จัดการประเภทสินค้า</p>
                      </div>
                      <div class="card-body" style="color: var(--bs-gray-900);background: #ffffff;">
                          <div id="dataTable" class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                            <table id="dataTable" class="table my-0">
                            <button class="btn-5" onclick="document.location='ad_add_type.php'">เพิ่มประเภทสินค้า</button>
                            <thead style="color: #000000;">
                              <tr style="color: #000000;">
                                <th style="color: #ff008a;">ลำดับที่</th>
                                <th style="color: #ff008a;">รหัสประเภทสินค้า</th>
                                <th style="color: #ff008a;">ประเภทสินค้า</th>
                          ...
                          <tbody style="color: #000000;">
                              ...
                              <tr> 
                                  ...
                                  <td><a href="ad_del_type.php?type_id=<?php echo $data["type_id"];?>" class="btn btn-danger" onclick="return confirm('จะลบเค้าหย๋อออ?')">ลบ</a>
                                  <a href="ad_edit_type.php?type_id=<?php echo $data["type_id"];?>" class="btn btn-warning"  >แก้ไข</a></td>
                              </tr>
                              <?php
                                    }
                              ?>
