...
<div class="container">
  ...
  <?php
        ...
        $data="SELECT*FROM product_type WHERE type_id LIKE '$type_id'";
        $re_data=mysqli_query($conn, $data);
        $rw_data=mysqli_fetch_array($re_data);

    ?>
  <main class="form-signin w-100 m-auto">
    <form action="ad_type_id_edit.php" method="GET">
      <img class="mb-4" src="ad_image/48.png" alt="" width="250" height="250">
        <h1 class="h3 mb-3 fw-normal"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">แก้ไขประเภทสินค้า<?php echo $rw_data['type_name'];?></font></font></h1>
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "type_id" id="floatinginput"  readonly value="<?php echo $rw_data['type_id'];?>">
        <label for="floating"><font "><font  required>รหัสประเภทสินค้า</font></font></label><br>
      </div>
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "type_name" id="floatinginput"  placeholder="ชื่อประเภทสินค้า" value="<?php echo $rw_data['type_name'];?>">
        <label for="floating"><font "><font  required>ชื่อประเภทสินค้า</font></font></label><br>
      </div>
