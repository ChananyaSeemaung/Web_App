...
<div class="card shadow">
    <div class="card-header py-3" style="color: rgb(255,8,122);">
        <p  style="color:#ff007b;">จัดการสมาชิก</p>
    </div>
    
        <div id="dataTable" class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
            <table id="dataTable" class="table my-0" style="width: 1050px;" >
                <thead style="color: #000000;">
                    <tr style="color: #000000;">
                        <th style="color: #ff008a;">ลำดับที่</th>
                        <th style="color: #ff008a;">ชื่อ</th>
                        <th style="color: #ff008a;">นามสกุล</th>
                        <th style="color: #ff008a;">อีเมล</th>
                        <th style="color: #ff008a;">เบอร์โทร</th>
                        <th style="color: #ff008a;">ผู้ใช้งาน</th>
                    </tr>
                </thead>
                <tbody style="color: #000000;">
                    ...
                    include("connect.php");
                    $sql = "SELECT * FROM member_tbl ORDER BY idc";
                    ...
                    ?>
                        <td><?php echo $n++ ;?></td>
                        <td style="color: #000000;"><?php echo $data['namem'];?></td>
                        <td style="color: #000000;"><?php echo $data['lnamem'];?></td>
                        <td style="color: #000000;"><?php echo $data['gmail'];?></td>
                        <td style="color: #000000;"><?php echo $data['phone'];?></td>
                        <td>
                        <?php if($userlever==0){ 
                            echo "<a class='btn btn-primary'>ผู้ใช้งาน</a>";
                          }elseif($userlever == 1){
                            echo "<a class='btn btn-success'>ผู้ดูแล </a>";}
                        ?>
                        </td>
                    </tr>
                    <tr style="color: #000000;"></tr>
