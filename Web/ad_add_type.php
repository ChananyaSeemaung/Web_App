...
<div class="container">
  ...
  <?php
            $data="SELECT * FROM product_type ORDER BY type_id";
            $re_data=mysqli_query($conn, $data);
            while($row=mysqli_fetch_array($re_data)){
            }
    ?>
  <main class="form-signin w-100 m-auto">
    <form action="ad_add_type_pro.php" method="POST">
      ...
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "type_name" id="floatinginput" >
