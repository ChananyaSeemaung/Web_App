                ...
                <div class="table-responsive-xxl">
                    ...
                    <div class="card shadow">
                      <div class="card-header py-3" style="color: rgb(255,8,122);">
                          <p  style="color:#ff007b;">จัดการสินค้า</p>
                      </div>
                      <div class="card-body" style="color: var(--bs-gray-900);background: #ffffff;">
                          <div id="dataTable" class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                            <table id="dataTable" class="table my-0">
                            <button class="btn-5" onclick="document.location='ad_add.php'">เพิ่มข้อมูลสินค้า</button>
                            <thead style="color: #000000;">
                              <tr style="color: #000000;">
                                <th style="color: #ff008a;">ลำดับที่</th>
                                <th style="color: #ff008a;">ชื่อสินค้า</th>
                                <th style="color: #ff008a;">ราคาสินค้า</th>
                                <th style="color: #ff008a;">จำนวน</th>
                                <th style="color: #ff008a;">รูปภาพสินค้า</th>
                                <th style="color: #ff008a; width: 200px;">Acciones</th>
                              </tr>
                          </thead>
                          <tbody style="color: #000000;">
                              ...
                              <tr> 
                                  <td><?php echo $n++;?></td>
                                  <td><?php echo $data['name_pro'];?></td>
                                  <td><?php echo $data['price_pro'];?></td>
                                  <td><?php echo $data['num_pro'];?></td>
                                  <td><img src = "img/<?php echo $data['image'];?>"width="100px" height="100px"></td>
                                  <td><a href="ad_del_cus.php?id_pro=<?php echo $data["id_pro"];?>" class="btn btn-danger" onclick="return confirm('จะลบเค้าหย๋อออ?')">ลบ</a>
                                  <a href="ad_edit.php?id_pro=<?php echo $data["id_pro"];?>" class="btn btn-warning"  >แก้ไข</a></td>
                              </tr>
                              <?php
                                    }
                              ?>
