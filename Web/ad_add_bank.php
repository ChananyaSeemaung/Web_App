...
<div class="row">
  ...
  <main class="form-signin w-100 m-auto">
    <form action="ad_add_bank_id.php" method="POST" enctype="multipart/form-data" >
      <img class="mb-4" src="ad_image/48.png" alt="" width="250" height="250">
      <h1 class="h3 mb-3 fw-normal"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">เพิ่มธนาคาร</font></font></h1>

          </select><br>
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "b_name" id="floatinginput" placeholder="ราคาสินค้า" required>
        <label for="floating"><font><font >ชื่อธนาคาร</font></></label><br>
      </div>
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "b_number" id="floatinginput" placeholder="จำนวนสินค้า"required>
        <label for="floating"><font><font  >เลขบัญชีธนาคาร</font></font></label><br>
      </div>
      <div class="form-floating">
        <input type="text"  class="form-control border-success" name = "b_owner" id="floatinginput" placeholder="รายระเอียดสินค้า"required>
        <label for="floating"><font><font  >เจ้าของบัญชี</font></font></label><br>
      </div>
      <div class="mb-3">
