                    ...
                    <div class="container-fluid px-4">
                        <div class="card mb-4 mt-4">
                            <div class="card-header">
                                ...
                                แสดงการข้อมูลการสั่งซื้อสินค้า (ยังไม่ได้ชำระเงิน)
                                <div><br>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php
$sql = "SELECT * FROM order_tbl WHERE order_status='1' ORDER BY reg_date DESC";
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="cancel_order.php?id=<?=$row['id_or']?>" class="btn btn-danger" onclick="return confirm('ต้องการยกเลิกใบสั่งซื้อสินค้าหรือไม่?')">ยกเลิก</a></td>
